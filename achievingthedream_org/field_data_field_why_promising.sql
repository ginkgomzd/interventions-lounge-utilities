...
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3791,8863,'und',0,'The course is designed to reduce the number of developmental education courses students must take for college readiness and increase critical thinking content.','','plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3795,8867,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3796,8891,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3797,8892,'und',0,'Acceleration is showing some promise as a strategy for moving students through remediation quickly. Pass rates in redesigned English courses are slightly higher. Both the above strategies are showing positive results.','','plain_text');
...
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3799,8894,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3800,8895,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3806,8901,'und',0,'Contextualized curriculum is a valuable process if instruction uses curriculum to make relationships among disciplines and to acelerate a student\'s progress to college level work.','','plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3807,8902,'und',0,'',NULL,'plain_text');
...
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3811,8906,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3813,8908,'und',0,'The success of the learning communities lies with the success of a newly designed college success course.',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3814,8909,'und',0,'',NULL,'plain_text');
...
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3816,8911,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3818,8913,'und',0,'',NULL,'plain_text');
...
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3821,8916,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3822,8917,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3825,8920,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3826,8921,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3827,8922,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3828,8923,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3829,8924,'und',0,'The success rate for students in developmental math have increased from 42% in spring 2010 to 55% in fall 2010 to 62% in fall 2011.','','plain_text');
...
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3831,8926,'und',0,'Improved retention from term-to-term and year-to-year.',NULL,'plain_text');
...
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3833,8928,'und',0,'This is a more intrusive approach with additional time on task which has contributed significantly to increased success rates (which when they first started were addmitedly extremely low).','','plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3834,8929,'und',0,'Higher success rates (77% for those who participated vs. 71% of those who did not).',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3835,8930,'und',0,'',NULL,'plain_text');
...
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3838,8933,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3839,8934,'und',0,'',NULL,'plain_text');
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3840,8935,'und',0,'',NULL,'plain_text');
...
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3842,8937,'und',0,'',NULL,'plain_text');
...
INSERT INTO `field_data_field_why_promising` VALUES ('node','mx_intervention',0,3844,8939,'und',0,'The mathematics faculty will be able to ascertain which form of lecture/lab combination is most effective.  Also, the modular approach is beneficial, especially for upper level students.',NULL,'plain_text');
