...
CREATE TABLE `video_output` (
  `vid` int(10) unsigned NOT NULL COMMENT 'Video ID.',
  `original_fid` int(10) unsigned NOT NULL COMMENT 'Original File ID.',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Track file id for conveted files.';
